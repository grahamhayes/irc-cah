...
var cardFiles = {
    ...
    PAXEastPanel2014ExpansionQuestions: __dirname + '/../config/card/PAXEastPanel2014Expansion_questions.json',
    PAXEastPanel2014ExpansionAnswers: __dirname + '/../config/card/PAXEastPanel2014Expansion_answers.json',
